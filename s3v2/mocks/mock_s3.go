...
// Source: github.com/shamaazi/parquet-go-source/s3v2 (interfaces: S3API)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_s3.go -package=mocks github.com/shamaazi/parquet-go-source/s3v2 S3API
//
